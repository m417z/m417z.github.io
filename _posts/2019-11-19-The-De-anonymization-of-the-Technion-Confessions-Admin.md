...
**Update:** You may wonder why I didn't use clickjacking the way I described in the [De-anonymization via Clickjacking in 2019]({{ site.baseurl }}/De-anonymization-via-Clickjacking-in-2019/) blog post. The reason is that this story predates the research that I've done about clickjacking.
